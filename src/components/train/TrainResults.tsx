...
import { formatActionLabel, formatCellEvPercent, formatCount } from '#utils/ui/format';
import {
	createGlobalKeydown,
	isEscapeConsumingTarget,
	isKeyConsumingTarget,
} from '#utils/app/keyboard';
...
import StatBand, { type StatFigure } from '#c/common/StatBand';

import '#styles/train/TrainResults';
